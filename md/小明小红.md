...
Process Explorer
---------------------------
Are you sure you want to kill shadowsocks.exe and its descendants?
---------------------------
确定   取消   
---------------------------
...
3：多项式分布
二项分布是多项式分布的特殊情况。多项式分布{x1,x2,...xn},
f(x1,x2,...,xn;n,p1,p2...,pn)=Pr(X=x1 and ...and Xk=xk)={}

同样的，与beta分布对应的是Dirichlet分布，依旧是Dirichlet 分布可以作为多项式分布的先验分布
